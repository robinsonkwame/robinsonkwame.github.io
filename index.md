...
The Sustainability Assessment project investigates and develops socio-technical systems that add approaches between institutional policy and individual responsibility. Examples include experiments in collaborative search engine re-ranking for sustainable consumption, supporting lifecycle analysis with object decomposition, and reconceptualizing impact assessments using personal and local frameworks.
