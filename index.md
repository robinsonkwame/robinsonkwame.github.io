...
Kwame’s sustainability assessment project investigates and develops socio-technical systems that add to institutional and individual approaches. Examples include experiments in search engine re-ranking for sustainable consumption, supporting lifecycle impact and analysis with object decomposition methods, and reconceptualizing impact assessment using personal and local frameworks.
